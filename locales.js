...
module.exports = {
    'en': {
        ...
        'ottobot.name': 'OTTOBOT',
        'ottobot.description': 'Otto Robot, get started with robot project.',
        'sdisplay.name': 'SDISPLAY',
        'sdisplay.description': 'TFT display',
        'slcd.name': 'LCD',
    ...
    'zh-cn': {
        ...
        'ultrasonic.name': '超声波',
        "ottobot.name": "奥托机器人",
        "ottobot.description": "奥托机器人，开始你的机器人项目。",
        "sdisplay.name": "TFT显示屏",
        "sdisplay.description": "TFT显示屏",
        "slcd.name": "LCD液晶屏",
